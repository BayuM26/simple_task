        ...
        <div class="hero min-h-screen bg-base-200">
            <div class="hero-content flex-col lg:flex-row-reverse">
                ...
                <div class=" w-full max-w-sm ">
                    <div class="bg-blue-500 rounded-full w-72 h-72 absolute opacity-70 filter blur-md animation-delay-2000 animate-blob mix-blend-multiply ms-36"></div>
                    <div class="bg-red-500 rounded-full w-72 h-72 absolute opacity-70 filter blur-md animation-delay-4000 animate-blob mix-blend-multiply -ms-10"></div>
                    <div class="bg-green-500 rounded-full w-72 h-72 absolute opacity-70 filter blur-md animate-blob mix-blend-multiply mt-32 ms-5"></div>
                    <div class="card flex-shrink-0 shadow-2xl glass">
